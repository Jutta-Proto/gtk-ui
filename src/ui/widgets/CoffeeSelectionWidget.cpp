...
CoffeeButton& CoffeeSelectionWidget::generate_button(const std::string& name, const jutta_bt_proto::Product* product, const std::string& cssClass, const Glib::RefPtr<Gtk::CssProvider>& cssProvider) {
    CoffeeButton* btn = Gtk::make_managed<CoffeeButton>(name, product, cssClass, cssProvider);
