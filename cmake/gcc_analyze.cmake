...
if(JUTTA_UI_STATIC_ANALYZE)
    if(JUTTA_UI_ENABLE_LINTING)
        message(FATAL_ERROR "Linting and the GCC static analysis can not be enabled at the same time! Disable either JUTTA_UI_STATIC_ANALYZE or JUTTA_UI_ENABLE_LINTING.")
    endif()
